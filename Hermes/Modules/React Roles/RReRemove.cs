...
namespace Hermes.Modules.React_Roles
{
    ...
    internal class RReRemove : CommandModuleBase
    {
        ...
        [DiscordCommand("redel", commandHelp = "redel <message-link> <emoji>",
            description = "Deletes the reaction role associated with the emoji",
            example =
                "redel https://discord.com/channels/591660163229024287/790477735352336384/798021230774321162 :weirdemoji:",
            IsPremium = true)]
