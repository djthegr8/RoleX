namespace Hermes.Modules.Services
{
    ...
    public enum CommandStatus
    {
        ...
        /// <summary>
        ///     There was an error with the execution, look at the exception in
        ///     <see cref="CustomCommandService.CommandResult.Exception" />
        /// </summary>
        Error,

        /// <summary>
        ///     Could not find a command, if this is a mistake check if you have the <see cref="DiscordCommand" /> attribute
