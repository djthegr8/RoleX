...
namespace Hermes.Modules.Services
{
    public class CustomCommandGlobals
    {
        ...
        {
            Context = new RunnableContext(context);
        }
        ...
        public static EmbedBuilder CreateEmbed(string Title = "", string Description = "", Color? Color = null,
            string Url = null, string ImageUrl = null, string FooterText = null, string FooterIconUrl = null)
        {
