...
namespace Hermes.Modules.Services
{
    ...
    public class DiscordCommand : Attribute
    {
        ...
        /// <summary>
        ///     If <see langword="true" /> then <see cref="Settings.HasPermissionMethod" /> will be called and checked if the user
        ///     has permission to execute the command, this result will be in the <see cref="CommandModuleBase" />
        /// </summary>
        public bool RequiredPermission { get; set; }

        /// <summary>
        ///     The prefix for the command. This is optional, the command will work with the default prefix you passed or an
        ///     overwrited one from the <see cref="DiscordCommandClass" />
        /// </summary>
