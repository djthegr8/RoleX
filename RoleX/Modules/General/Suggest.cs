...
namespace RoleX.Modules.General
{
    ...
    {
        [DiscordCommand("botsuggest", commandHelp = "botsuggest <suggestions-for-RoleX-to-improve>", description = "Tells the devs about a suggestion", example = "botsuggest new weird command")]
