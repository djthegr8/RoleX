...
Number Of Admins: {guild.Users.Count(Usr => Usr.GuildPermissions.Administrator)}
Number Of Mods: {guild.Users.Count(Usr => Usr.GuildPermissions.ManageChannels || Usr.GuildPermissions.ManageGuild || Usr.GuildPermissions.ManageRoles)}
